...
protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative pb/intercom.proto

echo "Building for Raspberry Pi Zero W"
GOOS=linux GOARCH=arm GOARM=6 go build -o compiled/gointercom_arm6
echo "Created gointercom_arm6 binary"
echo "Building for Raspberry Pi 4"
GOOS=linux GOARCH=arm GOARM=7 go build -o compiled/gointercom_arm7
